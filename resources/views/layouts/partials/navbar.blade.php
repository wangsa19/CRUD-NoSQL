<nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
    <div
        class="max-w-full flex flex-wrap items-center justify-between mx-auto py-4 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Motion Health - CRUD
                NoSQL</span>
        </a>
